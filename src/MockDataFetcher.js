...
export const getMockWorkflow = () => workflow;
export const getMockLeadAndCycleTimeData = () => leadAndCycleTimeData;
export const getMockThroughput = () => throughputData;
export const getMockCumulativeFlowData = () => cumulativeFlowData;
